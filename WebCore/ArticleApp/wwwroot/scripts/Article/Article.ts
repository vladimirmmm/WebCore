...
module Article {
    export class List extends ListViewModel<Models.Article[]>
    {
    ...
    export class Details extends ViewModel<Models.Article>
    {
        public Identifier(): string {
    ...
    export class Save extends ViewModel<Models.Article>
    {
        ...
        public Action(p: any) {
            ...
            var load = function () {
                ...
                let category = <App_AutoComplete>_SelectFirst("body > div.main.grid > div.container > div.Article.Save > div > div > div:nth-child(4) > app-autocomplete", me.UIElement);
            ...
            if (!IsNull(me.Model) && me.Model.Id == id) {
                ...
                if (IsNull(id)) {
                    me.Model = <Models.Article>{ TypeName: "Article" };
        ...
        public SavePost(element: Element) {
            var me = this;
            var obj: Models.Article = <any>GetBoundObject(me.UIElement);
            ...
            var model = <Models.Article>JsonCopy(me.Model);
            MapObject(obj, model);
    ...
    export class Controller extends ModelController {
        ...
        public GetControllerSpecificActions(model: Models.Article): AppUICommand[] {
            // 
        ...
        public TransformActionHtml(action: string, model: Models.Article, html: string, area: string): string {
            if (action == "Save") {
