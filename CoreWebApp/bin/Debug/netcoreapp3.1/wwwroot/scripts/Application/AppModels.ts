...
function GetDbCommandForObject(obj, commandname, keys: string = "Id", excludes: string[] = []): any {
...
function GetUpdateCommand(obj, typename, commandname, keys: string = "Id", excludes: string[] = ["Id"]) {
...
function GetDeleteCommand(typename, id: any) {
    var command = {};
